...
class ConnectDatabase{
    // Phải viết khi đi thi (Tài nguyên được cập trong file)
    // Khi đi thi chỉ dành riêng cho lớp thầy TrungNT173
    // Vì lớp có thêm phần bảo mật riêng biệt
    // Khai báo các thuộc tính
    public $pdo;
    public $sql;
    public $sta;
    // Viết PT khởi tạo kết nối CSDL
    public function __construct()
    {
        // Viết ngoại lệ
        try{
            // Viết kết nối
            // Có 1 chuỗi kết => yêu câu viết chuẩn theo
